    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      ...
      <div className="max-w-md w-full relative">
        <div className="text-center mb-8">
          ...
          <p className="text-[hsl(215_20%_70%)]">Start capturing websites today</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="flex items-center text-sm font-medium mb-3">
                <User className="w-4 h-4 mr-2 text-[hsl(187_92%_55%)]" />
                Name
              </label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                ...
                minLength={6}
              />
              <p className="text-xs text-[hsl(215_20%_55%)] mt-2">Minimum 6 characters</p>
            </div>
        ...
        <p className="text-center text-sm text-[hsl(215_20%_70%)] mt-6">
          ...
          <Link href="/login" className="text-[hsl(187_92%_55%)] hover:text-[hsl(187_92%_65%)] font-medium">
            Sign in
          </Link>
        </p>
      </div>
